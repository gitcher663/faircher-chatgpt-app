  ...
  return {
    ...
    faircher_search_ad_creative: {
      definition: {
        ...
        description:
          "Returns the most recent Search ad creative for a domain or advertiser keyword.",
        inputSchema: {
          type: "object",
          required: ["query"],
          properties: {
    ...
    faircher_display_ad_creative: {
      definition: {
        ...
        description:
          "Returns the most recent Display ad creative for a domain or advertiser keyword.",
        inputSchema: {
          type: "object",
          required: ["query"],
          properties: {
    ...
    faircher_video_ad_creative: {
      definition: {
        ...
        description:
          "Returns the most recent Video ad creative for a domain or advertiser keyword.",
        inputSchema: {
          type: "object",
          required: ["query"],
          properties: {
